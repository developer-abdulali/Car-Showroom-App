import { CarProps, FilterProps } from "@/app/components/types";

export async function fetchCars(filters: FilterProps) {
  const {manufacturer, year, fuel,model, limit} = filters
  const headers = {
    "X-RapidAPI-Key": "6e7651b000msh22330dd261834bfp1dee70jsn9a54567817c4",
...
export const generateCarImageUrl = (car: CarProps, angle?: string) => {
  ...
  url.searchParams.append("moderYear", `${year}`);
